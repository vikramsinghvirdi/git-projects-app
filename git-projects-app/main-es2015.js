...
const routes = [{
        ...
        children: [{
                path: '',
                pathMatch: 'full',
                loadChildren: () => __webpack_require__.e(/*! import() | modules-search-search-module */ "modules-search-search-module").then(__webpack_require__.bind(null, /*! ./modules/search/search.module */ "./src/app/modules/search/search.module.ts")).then(m => m.SearchModule)
            }]
    }];
